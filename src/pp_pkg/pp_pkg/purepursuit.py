...
class PurePursuit(Node):
    ...
    def pure_pursuit(self):
        ...
        self.get_logger().info(f"lastone: {self.last_visited_index}")
        ...
        cmd_vel = Twist()
        cmd_vel.linear.x = .2  # tune this value
        cmd_vel.angular.z = 1.0 * alpha  # tune this value
